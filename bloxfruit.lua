...
local TextButton = Instance.new("TextButton")   -- TextButton permet d'avoir Image + Text
...
TextButton.BackgroundColor3 = Color3.fromRGB(0, 0, 0)  -- Fond noir
TextButton.BackgroundTransparency = 0                  -- Opaque
...
-- TON IMAGE LOGO (en arrière-plan)
TextButton.Image = "rbxassetid://105214607548233"
TextButton.ImageColor3 = Color3.fromRGB(255, 255, 255)
TextButton.ScaleType = Enum.ScaleType.Fit              -- L'image s'adapte au bouton

-- LA LETTRE "B" PAR-DESSUS LE LOGO
TextButton.Text = "B"
TextButton.TextColor3 = Color3.fromRGB(255, 255, 255)  -- Blanc
TextButton.TextScaled = true                           -- La taille du texte s'adapte automatiquement
TextButton.Font = Enum.Font.GothamBold
-- (Optionnel) Si tu veux que le "B" soit un peu décalé :
-- TextButton.TextXAlignment = Enum.TextXAlignment.Center (défaut)
-- TextButton.TextYAlignment = Enum.TextYAlignment.Center (défaut)

-- COINS ARRONDIS (ajuste le chiffre pour plus ou moins d'arrondi)
UICorner.CornerRadius = UDim.new(0, 8)   -- 8 = joli arrondi
